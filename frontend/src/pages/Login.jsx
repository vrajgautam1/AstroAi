...
function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute w-[600px] h-[600px] bg-indigo-600/20 rounded-full blur-[100px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
            ...
            <div className="relative w-full max-w-[400px] bg-white/[0.05] backdrop-blur-xl p-8 rounded-2xl shadow-[0_0_40px_rgba(99,102,241,0.1)] border border-white/10 z-10 transition-all duration-300">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <input
                        ...
                        required
                        className="w-full h-[44px] px-4 rounded-xl bg-white/5 border border-white/15 text-white/90 placeholder-gray-500 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/50 focus:shadow-[0_0_15px_rgba(99,102,241,0.2)] focus:outline-none transition-all duration-300"
                    />
                    <input
                        type="password"
